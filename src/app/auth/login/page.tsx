...
export default function LoginPage() {
    ...
    return (
        // Bỏ container full screen bên ngoài đi vì layout đã lo rồi
        <div className="w-full max-w-[500px] px-6"> {/* Giới hạn chiều rộng Form */}
            ...
            <div className="bg-white border border-gray-300 rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            {/* Input Email với style giống Airbnb: Border tròn, focus rose */}
                            <input
                                type="email"
                                required
